...
public class LayoutCreator extends WriteCommandAction.Simple {
    ...
    protected void generateAdapter() {
        ...
        for (Element element : mElements) {
            ...
            if (element.nameFull != null && element.nameFull.length() > 0) { // custom package+class
                ...
                field.append(Definitions.paths.get(element.name));
            } else { // android.widget
            ...
            // field
            holderBuilder.append("public " + field + " " + element.fieldName + ";\n");
    ...
    protected void generateFields() {
        for (Element element : mElements) {
            ...
            mClass.add(mFactory.createFieldFromText("private " + field.toString() + " " + element.fieldName + ";", mClass));
        }
    }
